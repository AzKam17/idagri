...
3. Use recoil for state management.
4. Use shadcn/ui for UI components.
5. Use tailwindcss for styling.
6. Save everything in local storage. No need for a backend.
7. For maps use leaflet.
8. Use react-router for routing.
9. Use typescript for type safety.
10. Do not mention claude in commits
11. Start each commit with either "feat:", "fix:", "docs:", or "chore:" followed by a brief description of the change.
